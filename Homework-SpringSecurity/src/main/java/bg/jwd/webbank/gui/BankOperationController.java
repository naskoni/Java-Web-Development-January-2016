...
import bg.jwd.webbank.business.AccountsDatabase;
import bg.jwd.webbank.business.AccountsDatabaseImpl;
...
public class BankOperationController {
	...
	private final AccountsDatabase accountService = new AccountsDatabaseImpl();
	...
	public String createAccount(Model model, HttpServletRequest request) {
		...
		model.addAttribute("balance", initialAmount);
